          ...
          <>
            ...
            >
              ...
              <div className="mb-5">
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  Minutes after class start time before marking as late.
                  Default: 10.
                </p>
              </div>
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    Uses Google Gemini to verify a real person is present.
                    Disable for testing.
                  </p>
                </div>
                <button
            ...
            {/* Change Password */}
            <div
              className={`${dark ? "bg-gray-900 border-gray-800" : "bg-white border-gray-200"} border rounded-xl p-6 max-w-lg mt-6`}
            >
              <h2
